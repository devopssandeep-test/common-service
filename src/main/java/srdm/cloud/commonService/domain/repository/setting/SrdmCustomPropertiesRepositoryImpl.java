...
@Repository
public class SrdmCustomPropertiesRepositoryImpl implements SrdmCustomPropertiesRepository {

	private static final Logger logger = LoggerFactory.getLogger(SrdmCustomPropertiesRepositoryImpl.class);
